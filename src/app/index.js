...
export default function App() {
  ...
  const dataLegivel = now.toLocaleDateString('pt-BR', {weekday: 'long',day: '2-digit', month: 'long',year: 'numeric'});
  ...
  return (
    <View style={styles.root}>
      ...
      <LinearGradient colors={weather?.iconCode ? getGradientByIcon(weather.iconCode) : ['#0daae3', '#0f639f']} style={styles.mainCard}>
